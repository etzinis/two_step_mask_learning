...
class CTN(nn.Module):
    ...
    def forward(self, x):
        ...
        adfe_sources = masks * enc_mixture.unsqueeze(1)
    ...
    def load_best_model(cls, models_dir, regularizer,
                        freq_res, sample_res):
        dir_id = 'reg_{}_L_{}_N_{}'.format(
            regularizer, sample_res, freq_res)
    ...
    def encode_dir_name(cls, model):
        model_dir_name = 'reg_{}_L_{}_N_{}'.format(
            model.afe_reg, model.L, model.N)
